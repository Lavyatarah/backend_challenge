...
AFRICA_TALKING_USERNAME = os.getenv('AFRICA_TALKING_USERNAME', 'default_username')
AFRICA_TALKING_API_KEY = os.getenv('AFRICA_TALKING_API_KEY', 'default_api_key')
...
DATABASES = {
    'default': {
        ...
        'NAME': 'backend_challenge_db',  # Replace with your database name
        'USER': 'backend_user',  # Replace with your database username
